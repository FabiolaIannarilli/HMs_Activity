...
ggsave(plot = pl_trig, filename = "ms_figures/Fig4_Coyote_Wolf_patterns.jpg", device = "jpeg", units = "cm", width = 24, height = 10, dpi = 600)
...
```{r temp9}
# Cyclic cubic spline ('random-intercept only')
# Coyote
