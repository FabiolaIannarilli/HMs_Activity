...
#' @param method Character. Data can be simulated using a trigonometric function ("trigonometric") or a von Mises mixture ("vonMises"). See Details.
#' @param n_y1 Numeric. Number of independent events captured during the survey period.
#' @param pmix Vector of mixing proportions for peaks in activity.
#' @param mu_constant Vector of component means.
#' @param sdmu Numeric. Temporal shift in the component means.
