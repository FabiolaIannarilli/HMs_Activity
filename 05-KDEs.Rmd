...
In this chapter, we illustrate how to estimate activity patterns based on KDEs using these three packages. Then, we show the consequences of not aggregating data when estimateing activity patterns. As an example, we use camera-trap data of American black bears (*Ursus americanus*) collected in northern-Minnesota between mid-May and mid-July 2017 (@Iannarilliea2020).
