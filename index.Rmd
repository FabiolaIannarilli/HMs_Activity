...
All the analyses presented in the following chapters were performed in @R-base. The camera-trap data used in the real-case examples can be accessed at XXXX. Details on how this data were collected can be found in @Iannarilliea2021.
